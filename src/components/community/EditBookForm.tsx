...
import { updateExchangeBook, deleteExchangeBook } from '@/lib/actions/community-books'
...
export default function EditBookForm({ book }: { book: any }) {
    ...
    async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            if (imageUrl) {
                ...
                formData.set('image', book.image) // Garder l'ancienne image
            }

            const res = await updateExchangeBook(book.id, formData)
    ...
    async function handleDelete() {
        ...
        const res = await deleteExchangeBook(book.id)
