...
export default function ProductCarousel({ products, t }: ProductCarouselProps) {
            ...
            {products.slice(0, 6).map((product) => (
                ...
                >
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                        <div>
                            <p className="font-black text-[12px] text-gray-900 line-clamp-1 leading-tight">{product.title}</p>
                            <p className="text-[10px] text-gray-500 font-bold truncate">{product.author}</p>
                        </div>
                        <a 
