...
import GeminiTestForm from './GeminiTestForm'
import { Sparkles } from 'lucide-react'

export const metadata = {
    title: 'Configuration Gemini AI | Admin SuperEcom',
}
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-gray-100">
                <div>
                    <h1 className="text-5xl lg:text-6xl font-black text-black tracking-tighter mb-2 italic">
                        Gemini AI<span className="text-blue-600">.</span>
                    </h1>
            ...
            <div className="bg-white rounded-[3rem] border border-gray-100 shadow-xl shadow-black/5 p-12">
                <div className="max-w-3xl mx-auto">
                    <div className="flex items-center gap-4 mb-10">
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-black tracking-tight uppercase">API Google Gemini</h2>
                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1 italic">Clé secrète et configuration du modèle</p>
                        </div>
                    </div>
                    <GeminiConfigForm initialApiKey={apiKey} />
                </div>
            </div>
